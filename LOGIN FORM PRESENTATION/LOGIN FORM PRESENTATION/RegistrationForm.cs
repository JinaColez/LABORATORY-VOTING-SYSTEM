    ...
    public partial class RegistrationForm : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
                ...
                string query = "insert into login (email ,username, password, month, day, year) values('"+emailRegistration.Text+"', '"+usernameRegistration.Text+"', '"+passwordRegistration.Text+"', '"+monthSelection.SelectedItem+"', '"+daySelection.SelectedItem+"', '"+yearSelection.SelectedItem+"' )";
